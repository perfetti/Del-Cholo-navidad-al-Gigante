...
if ( self.ratio ) {
if (typeof this.options.barHeight === 'undefined') var barHeight=0;
else var barHeight=parseInt(this.options.barHeight,10);
num.height = num.width * self.ratio + barHeight;
};
